...
const ConversionPayment = () => {
  ...
  const conversionAmountChangeHandler = (e) => {
    console.log(e.target.value.trim())
    setConversionAmount(e.target.value.trim())
  }

  const fetchConversion = useCallback(() => {
    setIsLoading(true)
    axios
    .get('/user/payment-settings/get/6', {
        headers: {
      ...
      .then((response) => {
        ...
        if (response.status === 201 || response.status === 200) {
          ...
          setConversionAmount(response.data.payment_settings.amount)
        } else {
  ...
  const onSubmitHandler = async (e) => {
    ...
    setIsLoading(true)
    axios
    .put(`admin/payment-settings/edit/6`, data, {
      headers: {
                ...
                <div className='form-group row pb-4'>
                  ...
                  <div className='col-lg-6'>
                    <input
                      ...
                      onChange={conversionAmountChangeHandler}
                    />
                  </div>
                </div>
              </div>
