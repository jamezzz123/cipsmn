...
const HonoraryPayment = () => {
  ...
  const AmountChangeHandler = (e) => {
    ...
    setHonoraryAmount(e.target.value.trim())
  }
  ...
  const data = {
    amount: honoraryAmount,
    name: "honorary"
  }


    setIsLoading(true)
    console.log(honoraryAmount)
    axios
      .put(`admin/payment-settings/edit/1`, data, {
        headers: {
...
export default HonoraryPayment
